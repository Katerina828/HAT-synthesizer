...
# This file preprocess the original health zip dataset(contain 4 subsets) into one dataset. 
# The original file contains three-year information, we merge it without year.
